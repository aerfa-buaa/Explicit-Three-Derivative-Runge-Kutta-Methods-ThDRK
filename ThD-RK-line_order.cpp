...
public:
    ...
    {
        int i, j;
        a21 = 0.6, A1 = a21, A2 = a21 * a21 / 2.0, A3 = a21 * a21 * a21 / 6.0;
    ...
    void compt_ThD_36_line_SSP()
    {
        ...
        // a21 = 0.869270422229783,
        a21 = 1.0, A1 = a21, A2 = a21 * a21 / 2.0, A3 = a21 * a21 * a21 / 6.0;
        B1 = 1., B2 = 0., B3 = 0.;
    ...
    double dfdxxx(double *g, int i)
    {
        ...
        // 8ord
        y = (-*(g + i - 4) * 7. + *(g + i - 3) * 72. - *(g + i - 2) * 338.0 + *(g + i - 1) * 488.0 - *(g + i) * 0.0 - *(g + i + 1) * 488.0 + *(g + i + 2) * 338.0 - *(g + i + 3) * 72. + *(g + i + 4) * 7.) / dx / dx / dx / 240.0;
...
int main()
{
    int n, oder_n = 6, begin_cell = 20;
    double t = 2.0, CFL = 1.0; // 计算时间总长，CFL数  CFL = 0.66 1.45
    // n = begin_cell + 1;
